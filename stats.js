...
async function getDataFromApi() {
  ...
  console.log(arrayFuture)
   ...
   function PrintTableOne() {
     ...
     <td>with the highest percentage of attendance</td>
     ...
     document.getElementById("TablaEventsStatics").innerHTML = contenedorUno
   }
   PrintTableOne()
 
   function PrintTableTwo() {
     let contenedorDos = `<tbody id="TablaUpcoming">
     <tr>
       <td>Category</td>
       <td>Revenues</td>
    ...
    `
     ...
     document.getElementById("TablaUpcoming").innerHTML = contenedorDos
   }
   PrintTableTwo()
 
   function PrintTableThree() {
     let contenedorTres = `<tbody id="TablaPastEvents">
     <tr>
       <td>Category</td>
       <td>Revenues</td>
       <td>Percentage of attendance</td>
